...
console.log(null == undefined); // Inequality !=
...
console.log(0 != null);
console.log(0 != undefined);
console.log(null != undefined); // Identiy  or Strict Equality ===
...
console.log(5 >= 5);
console.log(7 < 6);
console.log(4 <= 6); // Logical Operators
// AND &&
// OR ||
// NOT !
...
console.log(5 < 7 || 4 < 4);
console.log(5 >= 7 || 4 > 4);
console.log(!Math.pow(2, 3)); // Falsy Values
...
function getGrade(score) {
  ...
  if (score < 0) {
    ...
    if (score > 25 && score <= 30) grade = 'A';else if (score > 20 && score <= 25) grade = 'B';else if (score > 15 && score <= 20) grade = 'C';else if (score > 10 && score <= 15) grade = 'D';else if (score > 5 && score <= 15) grade = 'E';else grade = 'F';
  }
